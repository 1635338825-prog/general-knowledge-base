...
> Build an Obsidian-style knowledge vault for source digestion, structured knowledge pages, and thesis-oriented writing workflows.

[![Release](https://img.shields.io/github/v/release/1635338825-prog/general-knowledge-base)](https://github.com/1635338825-prog/general-knowledge-base/releases)
[![Last Commit](https://img.shields.io/github/last-commit/1635338825-prog/general-knowledge-base)](https://github.com/1635338825-prog/general-knowledge-base/commits/master)
[![Repo Size](https://img.shields.io/github/repo-size/1635338825-prog/general-knowledge-base)](https://github.com/1635338825-prog/general-knowledge-base)
...
- `MinerU VLM`
  负责解析 PDF / PPT / DOCX 等资料，生成 `content.json` 和 `content.md`
- `Codex`
  负责把解析结果消化为 `digest.json`，并驱动主题页、实体页和写作页更新
- `qmd`
  负责本地检索与索引，让知识库支持自然语言查询与证据回查
